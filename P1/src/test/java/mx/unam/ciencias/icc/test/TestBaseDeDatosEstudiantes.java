...
public class TestBaseDeDatosEstudiantes {
    ...
    @Test public void testGetNumRegistros() {
        ...
        for (int i = 0; i < total; i++) {
            Anilist e = TestEstudiante.estudianteAleatorio();
    ...
    @Test public void testGetRegistros() {
        ...
        Anilist[] estudiantes = new Anilist[total];
        for (int i = 0; i < total; i++) {
    ...
    @Test public void testEliminaRegistro() {
        ...
        for (int i = 0; i < total; i++) {
            Anilist e = TestEstudiante.estudianteAleatorio(ini + i);
            bdd.agregaRegistro(e);
        }
    ...
    @Test public void testBuscaRegistros() {
        ...
        for (int k = 0; k < total/10 + 3; k++) {
            ...
            Double calificacion = Double.valueOf(estudiante.getPromedio());
            l = bdd.buscaRegistros(CampoEstudiante.calificacion, calificacion);
            Assert.assertTrue(l.getLongitud() > 0);
            Assert.assertTrue(l.contiene(estudiante));
            nodo = l.getCabeza();
            while (nodo != null) {
                Anilist e = (Anilist)nodo.get();
                Assert.assertTrue(e.getPromedio() >= calificacion.doubleValue());
                nodo = nodo.getSiguiente();
            }
            Double bp = Double.valueOf(calificacion.doubleValue() - 5.0);
            l = bdd.buscaRegistros(CampoEstudiante.calificacion, bp);
            Assert.assertTrue(l.getLongitud() > 0);
            Assert.assertTrue(l.contiene(estudiante));
            nodo = l.getCabeza();
            while (nodo != null) {
            ...
            Integer estreno = Integer.valueOf(estudiante.getEdad());
            l = bdd.buscaRegistros(CampoEstudiante.EDAD, estreno);
            Assert.assertTrue(l.getLongitud() > 0);
            Assert.assertTrue(l.contiene(estudiante));
            nodo = l.getCabeza();
            while (nodo != null) {
                Anilist e = (Anilist)nodo.get();
                Assert.assertTrue(e.getEdad() >= estreno.intValue());
                nodo = nodo.getSiguiente();
            }
            Integer be = Integer.valueOf(estreno.intValue() - 10);
        ...
        Assert.assertTrue(l.esVacia());
        l = bdd.buscaRegistros(CampoEstudiante.calificacion,
        ...
        Assert.assertTrue(l.esVacia());
        l = bdd.buscaRegistros(CampoEstudiante.calificacion, null);
        Assert.assertTrue(l.esVacia());
